        ...
        this.service.getSPKByReference(this.data.code)
            .then(spk => {
              console.log(spk);
                ...
                this.printStruk += "    <tr style='height:30px;'>";
                this.printStruk += "        <td colspan='3' class='text-left' style='height:20px;'><b> PT EFRATA RETAILINDO </b> </td>";
                this.printStruk += "    </tr>";
                this.printStruk += "    <tr style='height:30px;'>";
                this.printStruk += "        <td colspan='3' class='text-left' style='height:20px;'><b> Kel. Banaran, Kec. Grogol, Kab.Sukoharjo 57193 Jawa Tengah </b></td>";
                this.printStruk += "    </tr>";
                this.printStruk += "    <tr style='height:30px;'>";
                this.printStruk += "        <td colspan='3' class='text-left' style='height:20px;'><b>Indonesia </b> </td>";
                this.printStruk += "    </tr>";
                this.printStruk += "    <tr style='height:30px;'>";
                this.printStruk += "        <td colspan='3' class='text-left' style='height:20px;'><b>TRANSFER STOK </b><br/></td>";
                this.printStruk += "    </tr>";
                this.printStruk += "    <tr style='height:30px;'>";
                this.printStruk += "        <td colspan='3' class='text-left' style='height:20px;'>";
                ...
                this.printStruk += "    </tr>";
                this.printStruk += "    <tr style='height:30px;'>";
                this.printStruk += "        <td colspan='3' class='text-left' style='height:20px;'> ==================================== </td>";
                this.printStruk += "    </tr>";

                for (var item of this.data.items) {
                    this.printStruk += "    <tr style='height:30px;'>";
                    this.printStruk += "        <td class='text-left' style='padding-right:6pt; height:20px;'> " + item.item.code + " </td>";
                    this.printStruk += "        <td colspan='2' class='text-left' style='height:20px;'> " + item.item.name + " </td>";
                    this.printStruk += "    </tr>";
                    this.printStruk += "    <tr style='height:30px;'>";
                    this.printStruk += "        <td class='text-left' style='padding-right:6pt; height:20px;'> " + item.quantity.toLocaleString() + " X &nbsp; </td>";
                    this.printStruk += "        <td class='text-left' style='height:20px;'> " + (item.item.domesticSale).toLocaleString() + " </td>";
                    this.printStruk += "        <td class='text-right' style='height:20px;'> " + (item.item.domesticSale * item.quantity).toLocaleString() + " </td>";
                    this.printStruk += "    </tr>";
                    this.printStruk += "    <tr style='height:30px;'>";
                    this.printStruk += "        <td class='text-left' style='padding-right:6pt; height:20px;'> " + item.remark + " </td>";
                    this.printStruk += "    </tr>";
                ...
                this.printStruk += "    </tr>";
                this.printStruk += "    <tr style='height:30px;'>";
                this.printStruk += "        <td class='text-left' style='padding-right:6pt; height:20px;'>  Total Item:  </td>";
                this.printStruk += "        <td colspan='2' class='text-left' style='height:20px;'> " + totalItem + " </td>";
                this.printStruk += "    </tr>";
                this.printStruk += "    <tr style='height:30px;'>";
                this.printStruk += "        <td class='text-left' style='padding-right:6pt; height:20px;'> Grand Total: </td>";
                this.printStruk += "        <td colspan='2' class='text-left' style='height:20px;'> " + totalPrice.toLocaleString() + " </td>";
                this.printStruk += "    </tr>";
